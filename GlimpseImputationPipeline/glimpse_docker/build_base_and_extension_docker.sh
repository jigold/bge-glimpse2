...
DOCKER_BUILDKIT=1 docker buildx build --platform linux/amd64 -t temp_glimpse_base ${script_dir}/glimpse_base
DOCKER_BUILDKIT=1 docker buildx build --platform linux/amd64 -t ${tag} ${script_dir}
